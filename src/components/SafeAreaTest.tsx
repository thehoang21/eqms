        ...
        <div className="bg-slate-800 rounded-lg p-4">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            <div className="bg-slate-700 p-3 rounded">
              ...
              <div className="text-lg font-mono">{insets.top}</div>
            </div>
            <div className="bg-slate-700 p-3 rounded">
              <div className="text-slate-400 mb-1">Bottom</div>
              <div className="text-lg font-mono">{insets.bottom}</div>
            </div>
            <div className="bg-slate-700 p-3 rounded">
              <div className="text-slate-400 mb-1">Left</div>
              <div className="text-lg font-mono">{insets.left}</div>
            </div>
            <div className="bg-slate-700 p-3 rounded">
              <div className="text-slate-400 mb-1">Right</div>
              <div className="text-lg font-mono">{insets.right}</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-800 rounded-lg p-4">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between items-center bg-slate-700 p-3 rounded">
              ...
              <span className="font-mono">{viewportHeight.vh}</span>
            </div>
            <div className="flex justify-between items-center bg-slate-700 p-3 rounded">
              <span className="text-slate-400">100dvh (Dynamic)</span>
              <span className="font-mono">{viewportHeight.dvh}</span>
            </div>
            <div className="flex justify-between items-center bg-emerald-700 p-3 rounded">
              ...
              <span className="font-mono font-bold">{Math.round(vhDvhDiff)}px</span>
            </div>
          </div>
