...
// Mock data for last password change and active sessions
const LAST_PASSWORD_CHANGE = '2024-11-15 14:30:00';
const PASSWORD_EXPIRY_DATE = '2025-03-15';
const ACTIVE_SESSIONS = [
    { id: 1, device: 'Windows PC', location: 'Hanoi, Vietnam', ip: '192.168.1.100', lastActive: '2025-12-29 10:30:00', current: true },
    { id: 2, device: 'iPhone 13', location: 'Hanoi, Vietnam', ip: '192.168.1.105', lastActive: '2025-12-28 18:45:00', current: false },
    { id: 3, device: 'Chrome Browser', location: 'Ho Chi Minh, Vietnam', ip: '113.161.45.23', lastActive: '2025-12-27 09:15:00', current: false },
];
    ...
    return (
        <div className="space-y-6">
            ...
            {showExpiryWarning && (
                <div className="p-4 bg-amber-50 border border-amber-200 rounded-xl flex items-start gap-3">
                    ...
                    <div className="flex-1">
                        <h4 className="text-sm font-semibold text-amber-900">Password Expiration Warning</h4>
            ...
            <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl flex items-center gap-3">
                ...
                <div className="flex-1">
                    <h4 className="text-sm font-medium text-slate-900">Last Password Change</h4>
                    <p className="text-sm text-slate-600 mt-0.5">{LAST_PASSWORD_CHANGE}</p>
                </div>
            </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                {ACTIVE_SESSIONS.map((session) => (
                                    <div key={session.id} className="p-4 bg-slate-50 rounded-lg border border-slate-200 flex items-start gap-3">
                                        <div className="flex-1">
