            ...
            <div className="ml-4 sm:ml-7 p-3 sm:p-4 bg-slate-50 rounded-lg border border-slate-200 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full h-24 px-3.5 py-2.5 text-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 font-mono resize-none"
        ...
        <div className="space-y-4 p-5">
          ...
          <div>
            ...
            <div className="flex gap-2 mb-3">
              ...
              />
              <Button variant="default" size="sm" onClick={addCorsOrigin} className="h-10">
