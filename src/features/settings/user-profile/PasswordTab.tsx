                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className={cn(
                                            "w-full px-3.5 py-2.5 pr-24 text-sm border rounded-md bg-white focus:outline-none focus:ring-1 transition-all",
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className={cn(
                                            "w-full px-3.5 py-2.5 pr-10 text-sm border rounded-md bg-white focus:outline-none focus:ring-1 transition-all",
