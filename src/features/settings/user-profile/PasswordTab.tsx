                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className={cn(
                                            "w-full h-10 px-3.5 pr-24 text-sm border rounded-lg bg-white focus:outline-none focus:ring-1 transition-all",
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className={cn(
                                            "w-full h-10 px-3.5 pr-10 text-sm border rounded-lg bg-white focus:outline-none focus:ring-1 transition-all",
