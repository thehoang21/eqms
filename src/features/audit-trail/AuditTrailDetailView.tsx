...
import { IconLayoutDashboard, IconReportAnalytics } from "@tabler/icons-react";
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-3 lg:gap-4">
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1.5 text-slate-500 mt-1 text-xs whitespace-nowrap overflow-x-auto">
              ...
              <span className="text-slate-400 mx-1">/</span>
              <span className="text-slate-700 font-medium">Audit Trail Detail</span>
            </div>
          </div>
        ...
        <div className="xl:col-span-8 space-y-5">
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="p-5">
              <InfoRow
                label="Audit ID"
                value={<span className="font-mono">{record.id}</span>}
              ...
              <InfoRow
                label="IP Address"
                value={<span className="font-mono">{record.ipAddress}</span>}
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="p-5">
              ...
              <InfoRow
                label="Entity ID"
                value={<span className="font-mono">{record.entityId}</span>}
              />
