...
const MOCK_COURSE_DATA = {
  ...
  recurrence: { enabled: true, intervalMonths: 12 } as Recurrence,
  instruction:
...
export const EditCourseView: React.FC = () => {
  ...
  // Distribution List
  const [distributionList, setDistributionList] = useState<string[]>(courseData.distributionList);
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-3 lg:gap-4">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5 text-slate-500 mt-1 text-xs whitespace-nowrap overflow-x-auto">
            ...
            <span className="sm:hidden">...</span>
            <span className="text-slate-400 mx-1">/</span>
            <span className="text-slate-700 font-medium">Edit Course</span>
          </div>
        </div>
