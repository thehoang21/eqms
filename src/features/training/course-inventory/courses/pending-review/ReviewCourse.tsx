...
export const ReviewCourse: React.FC = () => {
  ...
  const [eSignAction, setESignAction] = useState<"complete-review" | "reject" | null>(null);
    ...
    return (
      <div className="space-y-6 w-full flex-1 flex flex-col">
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="sm" onClick={() => navigate(ROUTES.TRAINING.PENDING_REVIEW)} className="gap-2">
            Back
          </Button>
        </div>
  ...
  return (
    <div className="space-y-6 w-full flex-1 flex flex-col">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-3 lg:gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <Button variant="outline" size="sm" onClick={() => navigate(ROUTES.TRAINING.PENDING_REVIEW)}>
              Cancel
            </Button>
            {canAct && (
              <>
                ...
                <Button size="sm" onClick={handleCompleteReview} disabled={isSubmitting} className="bg-emerald-600 hover:bg-emerald-700 text-white gap-1.5">
                  <span className="hidden sm:inline">{isSubmitting ? "Processing..." : "Complete Review"}</span>
      ...
      <ESignatureModal
        ...
        actionTitle={eSignAction === "complete-review" ? "Confirm Content Review" : "Reject Course"}
      />
    </div>
  );
};
