...
import type { MatrixFilters, EmployeeRow, SOPColumn, TrainingCell } from "../../types";
...
const MatrixHead: React.FC<MatrixHeadProps> = ({ onSOPHeaderClick }) => (
  <thead>
    <tr>
      {/* No. */}
...
const MatrixBody: React.FC<MatrixBodyProps> = ({
  employees,
  filters,
  hasActiveFilters,
  onClearFilters,
            ...
            return (
              ...
              >
                <button
                  ...
                  onClick={(e) => !isGapHidden && onCellClick(e, emp, sop)}
