...
export const MOCK_MATERIALS: TrainingMaterial[] = [
  {
    ...
    type: "Video", version: "2.1", department: "Quality Assurance", status: "Approved", uploadedAt: "15/02/2026", uploadedBy: "John Doe",
  ...
  },
  {
    ...
    type: "PDF", version: "3.0", department: "Production", status: "Approved", uploadedAt: "10/02/2026", uploadedBy: "Jane Smith",
  ...
  },
  {
    ...
    type: "Image", version: "1.0", department: "HSE", status: "Approved", uploadedAt: "20/02/2026", uploadedBy: "Sarah Williams",
  ...
  },
  {
    ...
    type: "Document", version: "2.0", department: "Quality Control", status: "Approved", uploadedAt: "01/02/2026", uploadedBy: "Emily Davis",
  ...
  },
  {
    ...
    type: "Document", version: "2.3", department: "Quality Control", status: "Approved", uploadedAt: "28/01/2026", uploadedBy: "Lisa Anderson",
  ...
  },
  {
    ...
    type: "Video", version: "1.0", department: "Quality Assurance", status: "Approved", uploadedAt: "10/02/2026", uploadedBy: "Michael Chen",
  ...
  },
  {
    ...
    type: "PDF", version: "3.1", department: "HSE", status: "Approved", uploadedAt: "15/02/2026", uploadedBy: "Patricia Wilson",
