              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div className="flex-1 flex flex-col sm:flex-row gap-2">
                  <textarea
                    ...
                    rows={3}
                    className="flex-1 px-3 md:px-4 py-2 md:py-2.5 border border-slate-200 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-emerald-500/20 focus:border-emerald-500 resize-none"
                  />
                  <button
