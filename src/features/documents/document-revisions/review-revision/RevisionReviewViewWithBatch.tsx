...
import { DocumentWorkflowLayout, DEFAULT_WORKFLOW_TABS } from "@/features/documents/all-document/new-document/DocumentWorkflowLayout";
                                  ...
                                  <div className="flex items-start justify-between gap-4">
                                    <div>
                                      ...
                                      <p className="text-sm text-slate-600">
                                        Please review the document revision and provide your decision.
                                      </p>
                                    </div>
