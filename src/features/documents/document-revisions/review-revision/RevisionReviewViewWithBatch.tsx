...
const MOCK_COMMENTS: Comment[] = [
    {
        ...
        content: "Added new section 4.5 covering the new chromatograph calibration.",
    },
];

export const RevisionReviewViewWithBatch: React.FC<RevisionReviewViewProps> = ({
    documentId,
    onBack,
    currentUserId = "1",
    batchDocuments = [],
    ...
    const {
        ...
        batchDocuments: enableBatchMode ? (batchDocuments.length > 0 ? batchDocuments : MOCK_BATCH_REVISIONS) : [],
                ...
                <div className="space-y-6">
                   ...
                   <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                       <div className="p-4 bg-slate-50 border-b border-slate-200 flex justify-between items-center">
                           <span className="font-medium text-slate-700">Preview: {document.title} (v{document.version})</span>
                                ...
                                <div className="inline-flex items-center gap-1.5 lg:gap-2 px-2.5 lg:px-3 py-1 lg:py-1.5 bg-slate-50 border border-slate-200 rounded-lg w-fit">
                                    {document.reviewFlowType === 'sequential' ? (
                                        <>
                                            ...
                                            <span className="text-xs sm:text-sm font-medium text-slate-700">Sequential Review</span>
                                        </>
                                    ) : (
                                        <>
                                            <Users className="h-3.5 w-3.5 lg:h-4 lg:w-4 text-slate-600" />
                                            <span className="text-xs sm:text-sm font-medium text-slate-700">Parallel Review</span>
                                        </>
                                    )}
                                </div>
                            </div>
                                                    ...
                                                    <div className="flex flex-col gap-3">
                                                        ...
                                                        <div className="flex items-center justify-between gap-2">
                                                            ...
                                                            <div className="flex items-center gap-2 shrink-0 ml-auto">
                                                                {isSigned ? (
                                                                    <span className="inline-flex items-center gap-1.5 px-2.5 lg:px-3 py-1 lg:py-1.5 bg-emerald-50 text-emerald-700 rounded-full">
                                                                        <CheckCircle className="h-3.5 w-3.5 lg:h-4 lg:w-4" />
                                                                        <span className="text-xs font-medium">Signed</span>
                                                                    </span>
                                                                ) : (
                                                                    <span className="inline-flex items-center gap-1.5 px-2.5 lg:px-3 py-1 lg:py-1.5 bg-amber-50 text-amber-700 rounded-full">
