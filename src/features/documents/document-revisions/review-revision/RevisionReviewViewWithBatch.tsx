                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                        ...
                        >
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                                <h3 className="text-base md:text-lg font-bold text-slate-900">Review Workflow</h3>
                                <div className="inline-flex items-center gap-1.5 md:gap-2 px-2.5 md:px-3 py-1 md:py-1.5 bg-slate-50 border border-slate-200 rounded-lg w-fit">
                                    {document.reviewFlowType === 'sequential' ? (
                                        <>
                                            ...
                                            <span className="text-xs md:text-sm font-medium text-slate-700">Sequential Review</span>
                                        </>
                                    ) : (
                                        <>
                                            <Users className="h-3.5 w-3.5 md:h-4 md:w-4 text-slate-600" />
                                            <span className="text-xs md:text-sm font-medium text-slate-700">Parallel Review</span>
                                        </>
                                    )}
                                </div>
                            </div>
