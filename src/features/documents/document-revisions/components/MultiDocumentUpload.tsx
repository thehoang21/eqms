                ...
                <div className="flex items-start justify-between gap-4">
                    ...
                    {allFilesUploaded && (
                        <div className="flex items-center gap-2 bg-emerald-100 text-emerald-700 px-4 py-2 rounded-lg">
                            ...
                            <span className="font-medium text-sm">All files uploaded!</span>
                        </div>
                    )}
                </div>
            </div>
                    ...
                    return (
                        ...
                        >
                            <div className="flex items-center gap-4 p-4">
                                {/* Slot Number Badge */}
                                <div className="w-10 h-10 bg-emerald-600 text-white rounded-lg flex items-center justify-center font-bold text-sm shadow-sm shrink-0">
                                    {index + 1}
                                </div>
                                    ...
                                    {!hasFile ? (
                                        <div className="flex flex-col items-end gap-2">
                                            ...
                                            <button
                                                ...
                                                className={cn(
                                                    "px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-lg transition-all flex items-center gap-2 shadow-sm",
