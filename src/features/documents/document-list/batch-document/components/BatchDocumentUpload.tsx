...
export const BatchDocumentUpload: React.FC<BatchDocumentUploadProps> = ({
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white border-2 border-slate-200 rounded-xl p-4 lg:p-5 shadow-sm">
                {/* Header with actions */}
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 lg:gap-3 mb-3">
                    ...
                    {documents.length > 0 && (
                        ...
                        >
                            <IconTrash className="h-3.5 w-3.5 lg:h-4 lg:w-4 mr-1.5 lg:mr-2" />
                            <span className="text-xs lg:text-sm">Delete All</span>
                        </Button>
                    )}
                </div>
                
                {/* Description */}
                <p className="text-xs lg:text-sm text-slate-600 mb-3 lg:mb-4 leading-relaxed">
                ...
                {/* Stats Row */}
                <div className="flex flex-wrap items-center gap-2 lg:gap-3 text-xs lg:text-sm mb-3 lg:mb-4">
                    <div className="flex items-center gap-1.5 lg:gap-2">
                        <FileText className="h-3.5 w-3.5 lg:h-4 lg:w-4 text-slate-600" />
                ...
                {(batchParentId || globalParentId) && documents.length > 0 && (
                    <div className="space-y-2 lg:space-y-3 pt-2 lg:pt-3 border-t border-slate-200">
                        {/* Parent Node */}
                        {batchParentId ? (
                            <div className="flex items-start gap-2 lg:gap-3 p-2.5 lg:p-3 bg-gradient-to-r from-emerald-50 to-green-50 border-2 border-emerald-300 rounded-lg">
                                <Star className="h-4 w-4 lg:h-5 lg:w-5 text-emerald-600 shrink-0 mt-0.5" />
                                <div className="flex-1 min-w-0">
                                    <p className="text-xs lg:text-xs font-semibold text-emerald-800 uppercase tracking-wide">
                                        Parent Document (Batch)
                                    </p>
                                    <p className="text-xs lg:text-sm font-medium text-slate-900 mt-1 truncate">
                        ...
                        {/* Children Nodes */}
                        {childDocs.length > 0 && (
                            <div className="ml-4 lg:ml-8 space-y-2 border-l-2 border-slate-300 pl-2 lg:pl-4">
                                <p className="text-xs lg:text-xs font-semibold text-slate-600 uppercase tracking-wide mb-2">
                                    Child Documents ({childDocs.length})
                                </p>
                                {childDocs.map((doc) => (
                                    <div key={doc.id} className="flex items-center gap-1.5 lg:gap-2 p-2 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            {documents.length > 0 && !batchParentId && (
                <div className="bg-gradient-to-br from-cyan-50 to-blue-50 border-2 border-cyan-300 rounded-xl p-3 lg:p-5 shadow-sm">
                    ...
                    <div className="space-y-3">
                        ...
                        {globalParentId && (
                            <div className="flex items-center gap-1.5 p-2 lg:p-2.5 bg-emerald-100 border border-emerald-200 rounded-lg">
            ...
            {documents.length > 0 && batchParentId && (
                <div className="bg-gradient-to-br from-emerald-50 to-green-50 border-2 border-emerald-300 rounded-xl p-4 lg:p-5 shadow-sm">
                    <div className="flex items-start gap-2 lg:gap-3">
                        <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-lg bg-emerald-100 flex items-center justify-center shrink-0">
                            <Star className="h-4 w-4 lg:h-5 lg:w-5 text-emerald-600" />
                        </div>
                        <div className="flex-1">
                            ...
                            <div className="flex items-center gap-1.5 lg:gap-2 p-2.5 lg:p-3 bg-white border border-emerald-200 rounded-lg">
                                <FileText className="h-3.5 w-3.5 lg:h-4 lg:w-4 text-emerald-600 shrink-0" />
            ...
            {documents.length === 0 ? (
                ...
                <LayoutGroup>
                    ...
                    <div className="space-y-2 lg:space-y-3">
                        <h4 className="text-xs lg:text-sm font-semibold text-slate-700 mb-2 lg:mb-3 flex items-center gap-1.5 lg:gap-2">
                            <FileText className="h-3.5 w-3.5 lg:h-4 lg:w-4 text-slate-600" />
                            ...
                            <AnimatePresence mode="popLayout">
                                {documents.map((doc, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className={cn(
                                                "border-2 rounded-xl p-3 lg:p-5 transition-all",
                                                ...
                                                <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:gap-4">
                                                    ...
                                                    <div className="flex items-start gap-2 lg:gap-3 flex-1 min-w-0">
                                                        {/* Document Number */}
                                                        <div className="flex items-center justify-center w-7 h-7 lg:w-8 lg:h-8 rounded-full bg-slate-100 border-2 border-slate-200 shrink-0">
                                                        ...
                                                        {/* File Icon */}
                                                        <div className={cn(
                                                            "w-12 h-12 lg:w-12 lg:h-12 rounded-lg flex items-center justify-center shrink-0",
                                                            isBatchParent(doc.id)
                                                                ? "bg-emerald-100"
                                                                : effectiveParent 
                                                                    ? "bg-blue-100" 
                                                            ...
                                                            {getFileIcon(doc.fileName) ? (
                                                                <img 
                                                                    ...
                                                                    alt="File Icon" 
                                                                    className="h-8 w-8 lg:h-8 lg:w-8 object-contain"
                                                                />
                                                            ) : (
                                                                <FileText className={cn(
                                                                    "h-6 w-6 lg:h-6 lg:w-6",
                                                                    isBatchParent(doc.id)
                                                                        ? "text-emerald-600"
                                                                        : effectiveParent 
                                                                            ? "text-blue-600" 
                                                        ...
                                                        {/* File Info */}
                                                        <div>
                                                            <p className="text-xs lg:text-sm font-semibold text-slate-900 truncate">
                                                                {doc.fileName}
                                                            </p>
                                                        ...
                                                        {isBatchParent(doc.id) ? (
                                                            <div className="flex items-center gap-1.5 lg:gap-2 p-2 lg:p-2.5 bg-gradient-to-r from-emerald-100 to-green-100 border-2 border-emerald-300 rounded-lg">
                                                                <Star className="h-3.5 w-3.5 lg:h-4 lg:w-4 text-emerald-600 shrink-0" />
                                                                <div className="flex-1">
                                                            ...
                                                            <div className="flex items-start gap-1.5 lg:gap-2 p-2 lg:p-2.5 bg-blue-100 border border-blue-200 rounded-lg">
                                                                <Network className="h-3.5 w-3.5 lg:h-4 lg:w-4 text-blue-600 shrink-0 mt-0.5" />
                                                                <div className="flex-1 min-w-0">
                                                                    {(() => {
                                                    ...
                                                    {/* Actions Row - Mobile: icon-only, Desktop: icon + text */}
                                                    <div className="flex items-center gap-1 sm:gap-2 w-full lg:w-auto lg:shrink-0">
                    ...
                    <div
                        className={cn(
                            "border-2 border-dashed rounded-xl p-8 lg:p-6 text-center transition-all duration-200 touch-manipulation",
                            dragOver 
                    ...
                    {/* Success Message */}
                    {documents.length > 0 && (
                        <div className="flex items-start gap-2 lg:gap-3 bg-emerald-50 border-2 border-emerald-300 rounded-xl p-4 lg:p-5 shadow-sm">
                            <CheckCircle2 className="h-4 w-4 lg:h-5 lg:w-5 text-emerald-600 shrink-0 mt-0.5" />
                            <div className="flex-1">
                                <p className="text-xs lg:text-sm font-medium text-emerald-900">
                                    Ready to Continue
                                </p>
