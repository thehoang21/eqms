...
import { useBatchNavigation, BatchDocument } from "../new-document/useBatchNavigation";
import {
                                ...
                                <div className="mt-4 pt-4 border-t border-slate-200">
                                    <div className="flex gap-3">
                                        <textarea
                                            ...
                                            className="flex-1 min-h-[80px] px-4 py-3 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 resize-none"
                                        />
                                        <Button
