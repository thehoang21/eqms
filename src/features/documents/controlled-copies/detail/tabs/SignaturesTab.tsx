          ...
          <React.Fragment key={index}>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  readOnly
                  className="flex-1 h-10 px-3 py-2 bg-slate-100 border border-slate-200 rounded-lg text-sm text-slate-700 focus:outline-none"
                />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                readOnly
                className="h-10 px-3 py-2 bg-slate-100 border border-slate-200 rounded-lg text-sm text-slate-700 focus:outline-none"
              />
            </div>
          </React.Fragment>
        ))}
