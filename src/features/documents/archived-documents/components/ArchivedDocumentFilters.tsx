                ...
                <div className="xl:col-span-4">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-9 pr-4 py-2 h-11 border border-slate-200 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500"
                        />
                    </div>
                </div>
