...
import { IconSmartHome, IconFolderFilled, IconFile, IconSearch, IconPlus, IconUpload, IconDownload, IconLayoutGrid, IconLayoutList } from "@tabler/icons-react";
                ...
                <div className="border-b border-slate-200 px-4 md:px-6 py-4">
                    <div className="space-y-3">
                        ...
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
                            ...
                            {/* View Mode Toggle */}
                            <div className="w-full sm:w-auto flex items-center gap-1 bg-slate-100 rounded-lg p-1">
                        <button
